...
// //in thi swe give space seperator

// //9.trim()- removes whitespace from both ends of a string and returns a new string

// let str2= "         nnnn  "
// console(str2)
// console.log(str2.yrim())

// //10. padStrart()- pads the current string wit =h aniother str (multiple)
...
// //11. padEnd()-pads the current string with anither string(multiple times , if needed ) until the resukting strng reaches the given length. the padding is applied from the end of the current string
// console.log(contact.padEnd(14, "-EXT"))

//12. charAT()-

// console.log(structuredClone.charAt(20))
