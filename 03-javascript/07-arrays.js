...
//  7. slice() - it is used to get a portion of array without modifying the original array. it takes two arguments - start index and end index .// When only the starting index is given, slice() automatically takes all characters from that index to the end of the string.
...
// //sum- accumulator (stores running result). 0 is the starting value of sum.
