...
//humne yha sbki value get krli .ab js ka code linewise execute hota hai to humne yha sare ele ki value get nhi kri sirf ele ko get kera hai. kiuki starting mai in input k ander koi value haihi nhi isliye sirf yha humn elements get kra 
...
//ab hum .value k sath end mai hum sb element ki value get kr rhe hai nd var mai store kera diya . ab sari val store ho gyi
//kiuki val tbhi get hoti jb user ne sari value fill krdi hai .
// humne ab validation lagayi
//html vali validation hata k js laganai kiuki html value sirf ye chek krti ki form ki value empty na ho

//apss k liye regular expression kre jate hai / / k ander
// !(/[0-9]/.test(password)) bracket k ander ki value true return karegi isloye humne agge not laga diya. so hyumne kya kiya agr inmai se ekbhi false hua to alert show kr dena
